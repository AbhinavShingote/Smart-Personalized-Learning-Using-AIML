    ...
    <div className="mb-4">
      ...
      <div className="relative">
        <input
          ...
          className={`w-full bg-black/30 border rounded-xl px-4 py-3 text-[15px] text-slate-100
            placeholder-slate-600 outline-none transition-all duration-200
            focus:bg-indigo-950/30 focus:ring-2 focus:ring-indigo-500/30
            ${error
  ...
  return (
    <button
      ...
      className="w-full mt-2 py-3.5 px-6 rounded-xl font-semibold text-[15px] text-white
        bg-gradient-to-br from-indigo-500 to-violet-600 tracking-wide
  ...
  return (
    ...
    >
      ...
      <form onSubmit={handleSubmit} noValidate>
        ...
        <SubmitButton loading={loading}>Sign In to SmartLearn →</SubmitButton>
      </form>
  ...
  return (
    <button
      ...
      className="w-full py-3 bg-white/[0.04] border border-white/[0.08] rounded-xl
        text-sm text-slate-400 hover:bg-white/[0.07] hover:text-slate-200
    ...
    <div className="relative flex min-h-screen bg-[#060A14] overflow-hidden">
      ...
      <div className="hidden lg:flex flex-1 flex-col justify-center px-16 relative z-10">
        ...
        <div className="flex items-center gap-3 mb-16">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-indigo-500 to-violet-600 flex items-center justify-center text-white font-bold text-lg font-display">
            S
          </div>
        ...
        {/* Tag */}
        <div className="inline-flex items-center gap-2 bg-indigo-500/10 border border-indigo-500/25 rounded-full px-4 py-1.5 w-fit mb-6">
        ...
        <p className="text-base text-slate-500 leading-relaxed max-w-sm mb-12">
        ...
        <div className="flex items-center gap-10">
          {[
            ...
            <React.Fragment key={s.label}>
              ...
              <div>
                <div className="font-display text-3xl font-bold text-slate-100 tracking-tight leading-none">
                  {s.num}
                </div>
      ...
      <div className="w-full lg:w-[480px] flex items-center justify-center p-8 relative z-10">
        <div className="w-full max-w-[400px]">
          ...
          <div className="flex items-center gap-3 mb-8 lg:hidden">
            <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-indigo-500 to-violet-600 flex items-center justify-center text-white font-bold font-display">
              S
            </div>
            <span className="text-base font-semibold text-slate-100 font-display">SmartLearn</span>
          </div>
          ...
          <p className="text-center text-xs text-slate-700 mt-6">
            ...
            <Link to="/terms" className="text-slate-500 hover:text-slate-400 transition-colors">
              Terms of Service
            </Link>{" "}
            &amp;{" "}
            <Link to="/privacy" className="text-slate-500 hover:text-slate-400 transition-colors">
              Privacy Policy
            </Link>
          </p>
        </div>
